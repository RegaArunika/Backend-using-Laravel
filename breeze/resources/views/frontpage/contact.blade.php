...
<head>
    ...
    <title>Contact Us - Bali Dewata Dest</title>
...
<body class="font-sans antialiased">
    <div class="min-h-screen bg-white">
        ...
        <!-- Page Content -->
        <main class="items-center lg:w-8/12 mx-auto pb-20">
            <div class="contact-head text-center lg:pt-28 lg:pb-10">
                <h1 class="font-bold text-4xl pb-4">Contact Us</h1>
                <p class="text-xl justify-center">Ingin Mengetahui Lebih Lanjut? Silahkan isi di bawah ini</p>
            </div>
            <div class="main-contact">
                <form action="" class="space-y-8" method="POST">
                    ...
                    <button type="" class="py-3 px-5 text-sm font-medium text-center text-white bg-purple-700 rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"> <a href="landingpage">Send message</a></button>
                </form>
            </div>
        </main>
    </div>
